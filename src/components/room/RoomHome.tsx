                        ...
                        objects?.length > 0
                            ...
                            <>
                                <div className="resume">
                                    ...
                                    <audio id='localAudioRef' playsInline autoPlay muted />
                                    <video className="video-user" id='localVideoRef' playsInline autoPlay muted />
                                    {getUsersWithoutMe()?.map((user: any) =>
                                        <>
                                            <audio key={`audio-${user.clientId}`} id={`audio-${user.clientId}`} playsInline autoPlay muted={user?.muted} />
                                            <video className="video-user" key={`video-${user.clientId}`} id={`video-${user.clientId}`} playsInline autoPlay muted={user?.muted} />
                                        </>
                                    )}
                                </div>
                                <RoomObjects
